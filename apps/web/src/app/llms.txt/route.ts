...
- SQL Server Projects — migration, version upgrade, Always On availability groups, failover clustering, disaster recovery and Azure SQL Managed Instance migration for SQL Server 2008 through 2022. Quoted as a fixed price against written acceptance criteria, with a dry run against a copy of production before every cutover.
